    ...
    return (
        <div>
            ...
            <p className="flex gap-4 items-center text-[#4b2b53] font-bold">Name : <span className="text-[#A21942]">{name}</span> </p>
             ...
             <Link to={`/books/${_id}`}>   <button className=" mt-2 font-bold bg-slate-600 hover:bg-[#ffffff] hover:shadow-md hover:text-[#4b2b53] px-4 py-2 text-[#a8a8a8] rounded-md"> Details</button></Link>
            </div>
            </div>
        </div>
    );
